...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4 center-block">
      <div class="fb-box">
        <h4 class="fb-head"><a href="http://www.andrewunderhill.org/monarch">Monarch Espresso Bar</a></h4>
        <div class="fancybox-thumb">  
          ...
          <p class="fb-foot">A custom website built for a startup coffee shop in Tuscaloosa, Alabama</p>
      </div>
    </div>
